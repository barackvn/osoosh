...
templates = models_v_9.execute_kw(db_v_9, uid_v_9, password_v_9,
    'product.template', 'search_read',[[('active','=',False)]],{'offset': offset, 'limit': size})
...
for i, template in enumerate(templates):
    ...
    search_temp = models_v_14.execute_kw(db_v_14, uid_v_14, password_v_14,
    'product.template', 'search_read',[[('database_id_v9','=',template['database_id_v9'])]],{'limit':1})
    if not search_temp:
...
#Product to work on:
#12
# <Fault 2: 'The operation cannot be completed: another model requires the record being deleted. If possible, archive it instead.\n\nModel: Unknown (Unknown), Constraint: product_related_rel_dest_id_fkey'> 530
# Updating
# Processed template id [530] 295 of 980 [30.102040816326532] %
# Processing [658] 296 of 980 [30.20408163265306] %
# <Fault 2: 'The operation cannot be completed: another model requires the record being deleted. If possible, archive it instead.\n\nModel: Unknown (Unknown), Constraint: product_related_rel_dest_id_fkey'> 530
# Updating
# Processed template id [530] 296 of 980 [30.20408163265306] %
# Processing [659] 297 of 980 [30.306122448979593] %
# <Fault 2: 'The operation cannot be completed: another model requires the record being deleted. If possible, archive it instead.\n\nModel: Unknown (Unknown), Constraint: product_related_rel_dest_id_fkey'> 530
# Updating
# Processed template id [530] 297 of 980 [30.306122448979593] %
# Processing [660] 298 of 980 [30.408163265306122] %
# <Fault 2: 'The operation cannot be completed: another model requires the record being deleted. If possible, archive it instead.\n\nModel: Unknown (Unknown), Constraint: product_related_rel_dest_id_fkey'> 530
# Updating
# Processed template id [530] 298 of 980 [30.408163265306122] %
# Processing [661] 299 of 980 [30.510204081632654] %
# Updating
# Processed template id [535] 299 of 980 [30.510204081632654] %
# Processing [662] 300 of 980 [30.612244897959183] %
# <Fault 2: 'The operation cannot be completed: another model requires the record being deleted. If possible, archive it instead.\n\nModel: Unknown (Unknown), Constraint: product_related_rel_dest_id_fkey'> 535
