        ...
        for product in product_ids:
            ...
            if product.is_pack:
                if product.wk_product_pack:
                    ...
                    for pp in product.wk_product_pack:
                        qty_avail.append(
                            variant_available[pp.product_name.id]["qty_available"]
                            / pp.product_quantity
                        )
                        vir_avail.append(
                            variant_available[pp.product_name.id]["virtual_available"]
                            / pp.product_quantity
                        )
                        inco_qty.append(
                            variant_available[pp.product_name.id]["incoming_qty"]
                            / pp.product_quantity
                        )
                        outgo_qty.append(
                            variant_available[pp.product_name.id]["outgoing_qty"]
                            / pp.product_quantity
                        )
